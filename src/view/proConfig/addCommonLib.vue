<template>
  <div class="addComLib">
    ...
    <div class="commonConfig">
      <h3>通用库配置</h3>
      <Card style="marginTop: 20px" v-for='(item,index) in dealTable'>
    ...
    <Drawer title="语音添加" v-model="addVoiceAi" width='800px'>
      <div class='addVoiceDrawer'>
        ...
        <div class='addVoiceMain'>
          ...
          <div v-if='localListShow' class="voiceMes" v-for="(item,index) in voiceAiNum">
            <div class="voice1">
              <div class="voice2">
          ...
          <div v-if='composeListShow' class="voiceMes" v-for="(item,index) in componseVoiceNum">
            <div class="voice1">
              <div class="voice2">
