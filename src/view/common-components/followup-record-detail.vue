	...
	<Modal
		...
		<Collapse :value="[1,2]">
			...
			<Panel name="2">
				记录详情
				<div slot="content">
					<div v-if="allData.visitFollowupRecordVo.mergePath" class="integrated-audio">
						<span>完整录音</span>
									...
									<ul v-if="item.fieldName">
										...
										<li>
											...
											<div class="result-wrap">
												...
												<RadioGroup v-else v-model="item.fieldValue" :disabled="!canEdit" class="result-wrap-radio-group">
