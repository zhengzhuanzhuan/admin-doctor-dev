<template>
  <div class="homeContent">
    <Row :gutter="8">
      ...
      <i-col :xs="12" :md="8" :lg="4" style="height: 120px;padding-bottom: 8px;">
        <infor-card shadow :icon='followRecord' :icon-size="36">
          <h4>随访记录审核</h4>
      ...
      <i-col :xs="12" :md="8" :lg="4" style="height: 120px;padding-bottom: 8px;">
        <infor-card shadow :icon='callOut' :icon-size="36">
          <h4>人工外呼记录</h4>
    ...
    <Card shadow>
      ...
      <div slot="extra" style="display: flex">
        <Select 
          ...
          style="width: 250px" 
          clearable>
          <Option v-for="item in diseaseNum" :value="item.icd" :key="item.diseaseId" placeholder="全部疾病" >{{ item.icdName }}</Option>
        </Select> 
        <Cascader 
          :data="menuList" 
          v-model="followTree" 
